...
dependencies {
    ...
    mapOf<String, () -> Any>(
        ...
        "modImplementation" to {
            "net.fabricmc:fabric-loader:${adapter.loader}"
            "com.terraformersmc:modmenu:${adapter.modmenu}"
        },
        "modRuntimeOnly" to {
        ...
        "implementation" to { project(":adapters:mc:${adapter.minecraft}") }
    ).forEach { (key, p) ->
