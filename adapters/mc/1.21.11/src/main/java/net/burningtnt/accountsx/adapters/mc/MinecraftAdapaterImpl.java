...
public class MinecraftAdapaterImpl implements MinecraftAdapter<AccountSessionImpl> {
    ...
    public <T extends BaseAccount> void switchAccount(AccountSessionImpl session) {
        ...
        Session s = new Session(storage.getPlayerName(), storage.getPlayerUUID(), storage.getAccessToken(), Optional.empty(), Optional.empty());
        ...
        ((MinecraftClientAccessor) client).setSkinProvider(new PlayerSkinProvider(
                ...
                apiServices,
                ((PlayerSkinProviderAccessor) client.getSkinProvider()).accountsX$getDownloader(),
    ...
    public void copyText(String text) {
        ...
        if (client.isOnThread()) {
            new Clipboard().set(client.getWindow(), text);
        } else {
